...
REM
REM Generated by Vivado on Thu Jul 02 15:47:20 +0800 2026
...
echo "xvlog --incr --relax -prj tb_ui_layer_vlog.prj"
call xvlog  --incr --relax -prj tb_ui_layer_vlog.prj -log xvlog.log
